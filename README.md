...
KumuluzEE AMQP enables you to easily send and recieve messages over the AMQP protocol. Currently, it includes the RabbitMQ-based implementation. The RabbitMQ documentation can be found [here](https://www.rabbitmq.com/).
...
## Channel
You can obtain RabbitMQ Channel by using `@AMQPChannel`. Then you can use this channel to send and receive messages ([Read more](https://www.rabbitmq.com/getstarted.html)).
```java
